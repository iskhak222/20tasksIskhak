...
public class tsaks {
    public static void main(String[] args) {
        ...
        ArrayList<String> sports = new ArrayList<>(Arrays.asList("Football", "Basketball", "Tennis", "Hockey"));
        ...
        ArrayList<String> cities = new ArrayList<>(Arrays.asList("London", "Paris", "Rome"));
